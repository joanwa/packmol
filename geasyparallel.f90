...
subroutine geasy(n, x, g) 
  ...
  double precision :: clength, a1, a2, a3, b1, b2, b3, c1, c2, d, w
  ...
  do itype = 1, ntype 
    if(comptype(itype)) then
      ...
      do imol = 1, nmols(itype) 
        ...
        do iatom = 1, natoms(itype) 
          ...
          call compcart(icart,xcart,xbar,ybar,zbar,&
    ...
    ! Add the atoms of this type of molecule to the lists
...
!
! Compute the main part of the gradient
!
...
subroutine gparc(icart,firstjcart,gxcar2)
  ...
  ! ARRAY ARGUMENTS
  double precision :: gxcar2(maxatom,3), tol

  ! LOCAL SCALARS
  integer :: jcart
  double precision :: a1,a2,a3,datom,dtemp, xdiff1, xdiff2, xdiff3
